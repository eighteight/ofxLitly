...
ofxLitly::ofxLitly() : scale(1), rotation(0), brightness(1) {
}

void ofxLitly::setup(int width, int height, int radius, float shape, int passes, float downsample) {
...
void ofxLitly::setScale(float scale) {
	this->scale = scale;
}

void ofxLitly::setRotation(float rotation) {
	this->rotation = rotation;
}

void ofxLitly::setBrightness(float brightness) {
...
ofTexture& ofxLitly::getTextureReference() {
...
void ofxLitly::draw(ofRectangle rect) {
    base.draw(rect);
}
